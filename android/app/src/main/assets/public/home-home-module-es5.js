  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(httpclient, service, elementRef, modalController, alertController, platform, router, navCtrl, storage, menu) {
          var _this = this;
          ...
          Network.addListener('networkStatusChange', function (val) {
            ...
            if (val.connected) {} else {
              ref.navCtrl.navigateRoot('/nointernet', {
                replaceUrl: true
              });
            }
          });
          this.service.getSid('sid').then(function (d) {
            return console.log("sid", _this.sid = d);
          });
        }
        ...
        _createClass(HomePage, [{
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      /*top institute*/
                      this.service.mainpagetopcourses().subscribe(function (data) {
                        _this2.result = data['data'];
                        console.log(_this2.result);
                        console.log('instituteid', _this2.result['inst_id']);

                        _this2.generateCourseDetails(_this2.result);
                      });
                      /*wallet-card*/
                    ...
                    case 3:
                      ...
                      this.service.wallet(result).subscribe(function (data) {
                        _this2.walletamt = data['data'];
                        console.log(_this2.walletamt[0]);
                      });
                      /*top course*/

                      this.service.mainpagetopcourses2().subscribe(function (data) {
                        _this2.resulttopcourse = data['data'];
                        console.log('topcoursedata', _this2.resulttopcourse);
                        console.log('instituteid', _this2.resulttopcourse['inst_id']);

                        _this2.generateCourseDetails2(_this2.resulttopcourse);
                      });
                      /*top ielts*/

                      this.service.mainpagetopcourses3().subscribe(function (data) {
                        _this2.resulttopcourse2 = data['data'];
                        console.log('topcoursedata', _this2.resulttopcourse2);
                        console.log('instituteid', _this2.resulttopcourse2['inst_id']);

                        _this2.generateCourseDetails3(_this2.resulttopcourse2);
                      });
          ...
          value: function ionViewDidEnter() {
            this.backButtonSubscription = this.platform.backButton.subscribeWithPriority(1, function () {
              navigator['app'].exitApp(); //this.presentAlertConfirm();
            });
          }
        }, {
          ...
          key: "ngOnDestroy",
          value: function ngOnDestroy() {// this.backButtonSubscription.unsubscribe();
          }
        }, {
          ...
          value: function generateCourseDetails(company) {
            ...
            if (company[i] != undefined) {
              this.service.mainpagetopcourses_knowmore(company[i].inst_id).subscribe(function (data) {
                _this3.coursesDetails[company[i].inst_id] = data.data;
                i++;

                _this3.generateCourseDetails(company, i);
              });
            } else {
              this.flag = true;
          ...
          key: "generateCourseDetails2",
          value: function generateCourseDetails2(company) {
            var _this4 = this;
            ...
            if (company[i] != undefined) {
              this.service.mainpagetopcourses_knowmore(company[i].inst_id).subscribe(function (data) {
                _this4.coursesDetails2[company[i].inst_id] = data.data;
                i++;

                _this4.generateCourseDetails2(company, i);
              });
            } else {
              this.flag = true;
          ...
          key: "generateCourseDetails3",
          value: function generateCourseDetails3(company) {
            var _this5 = this;
            ...
            if (company[i] != undefined) {
              this.service.mainpagetopcourses_knowmore(company[i].inst_id).subscribe(function (data) {
                _this5.coursesDetails3[company[i].inst_id] = data.data;
                i++;

                _this5.generateCourseDetails3(company, i);
              });
            } else {
              this.flag = true;
          ...
          value: function animation() {
            var animation = Object(_ionic_core__WEBPACK_IMPORTED_MODULE_6__["createAnimation"])('').addElement(this.testdiv.nativeElement).duration(1000).fromTo('opacity', '1', '0.5');
          }
        }, {
          key: "logout",
          ...
          key: "yourSearchFunction",
          value: function yourSearchFunction(value) {
